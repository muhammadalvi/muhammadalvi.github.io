...
\section{Experience}
    ...
    \smallskip    
    \coloredbullet\ %
    Lead a campaign to maintain an excellent standard of operational hygiene by creating command-line tools to assist in ticket analysis and mitigation
    ...
    \smallskip    
    \coloredbullet\ %
    Wrote a design document outlining business opportunity, offering a prospective project architecture, and detailing the quantitative success criteria
    ...
    \smallskip    
    \coloredbullet\ %
    Designed a web bases test suite for 3 test environments using React and Spring, leading to 21\% faster testing
    
    \smallskip    
    \coloredbullet\ %
    Optimized API to increase time-to-first-byte by 6\%
